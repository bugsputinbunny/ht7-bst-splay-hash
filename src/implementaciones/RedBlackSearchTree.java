...
public class RedBlackSearchTree<E extends Comparable<E>> extends AbstractStructure<E> implements OrderedStructure<E>
{
    ...
    /**
     * Devuelve el elemeto c de encontrarse dentro del árbol.
     * @param c Elemento que está siendo buscado dentro del árbol.
     * @return Elemento hallado dentro del árbol.
     */
    public E get(E c){
        return root.locate(c).value();
    }
